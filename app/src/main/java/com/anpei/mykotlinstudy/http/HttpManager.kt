...
import com.anpei.mykotlinstudy.utils.NetworkUtil
...
object HttpManager {
    ...
    val service: HttpApi by lazy ( LazyThreadSafetyMode.SYNCHRONIZED){
        getRetrofit().create(HttpApi::class.java)
    }
    private var token:String?= SpHelper.getToken()

    private fun getRetrofit():Retrofit{
        //获取retrofit实例
        return Retrofit.Builder()
            .baseUrl(HttpConstant.BASE_URL)  //自己配置
