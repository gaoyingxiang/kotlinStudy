package com.anpei.mykotlinstudy.utils.rbar;
...
// =================================  特殊情况 ======================================
    ...
    //方法重构
    public static void setSYsTemBarColor(Activity content, View mStatusBar){
        //判断SDK版本是否大于等于19，大于就让他显示，小于就要隐藏，不然低版本会多出来一个
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setTranslucentStatus(true,content);
            mStatusBar.setVisibility(View.VISIBLE);
            ViewGroup.MarginLayoutParams margin = new ViewGroup.MarginLayoutParams(mStatusBar.getLayoutParams());
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(margin);
            layoutParams.height = getStatusHeight(content) ;
            mStatusBar.setLayoutParams(layoutParams);

////            mStatusBar.getLayoutParams().height = getStatusHeight(content);
//            ViewGroup.LayoutParams l = mStatusBar.getLayoutParams();
//            l.height = getStatusHeight(content);
//            mStatusBar.setLayoutParams(l);
    ...
    //方法重构
    public static void setSYsTemBarColor(Activity content, View mStatusBar, boolean isRelayout){
        //判断SDK版本是否大于等于19，大于就让他显示，小于就要隐藏，不然低版本会多出来一个
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setTranslucentStatus(true,content);
            mStatusBar.setVisibility(View.VISIBLE);
